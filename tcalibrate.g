...
M558 K0 F150
G38.2 X{move.axes[0].userPosition + 20} P0 ; Adjust the + n amount to the travel limit (expected hole diameter is an upper bound)
M400
G60 S2                                     ; Save +X position to slot 2
G0 X0 R1 F300                              ; Return X to start position (disengage the probe) (slot 1)
G38.2 X{move.axes[0].userPosition - 20} P0 ; Ajust the - n amount to the travel limit
...
G38.2 Y{move.axes[1].userPosition + 20} P0 ; Adjust the + n amount to the travel limit
M400
...
G38.2 X{move.axes[0].userPosition + 20} P0 ; Adjust the + n amount to the travel limit
M400
