...
G1 Z15 F6000 ; Move Z up 15 mm at 6000 mm/min
...
G1 U289.3 F9900; Rotate turret (U) to 289.3 at 9900 mm/min (*** Inherits G91 relative positioning from unlock_turret.g? ***)
G4 P20 ; Dwell for 20 ms
; M451 ; FFF mode

M116 P1 S10 ; Wait until Tool 1 arrives within 10C of its set value
...
G1 U300.7 F9900 ; Rotate turret (U) to 300.7 at 9900 mm/min (*** Inherits G91 relative positioning from unlock_turret.g? ***)
G4 P20 ; Dwell for 20 ms
...
G1 U30 F9900 ; Rotate turret (U) to 30 at 9900 mm/min (*** Inherits G91 relative positioning from unlock_turret.g? ***)
G4 P20 ; Dwell for 20 ms
