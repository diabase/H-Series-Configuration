...
G1 H1 Z60 F6000 ; Attempt to move Z +60mm at 6000 mm/min, but halt when endstop triggered and set axis position to axis limit as defined with M208 in config.g
...
; Home X Y Z U
G1 H1 X-420 Y-180 Z220 U-380 F6000 ; Attempt to move X -420mm, Y -180mm, Z +220mm, and U -380mm at 6000 mm/min, but halt when endstop triggered and set axis position to axis limit as defined with M208 in config.g
G1 H2 X2 Y2 Z-2 U2 F6000 ; Move X +2mm, Y -2mm, Z -2mm, and U +2mm at 6000 mm/min, ignoring endstop while moving
G1 H1 X-20 Y-20 Z20 U-29.7 F3000 ; Attempt to move X -20mm, Y -20mm, Z +20mm, and U -29.7mm at 3000 mm/min, but halt when endstop triggered and set axis position to axis limit as defined with M208 in config.g
