...
M563 P2 D1:{#move.extruders-1} H2 L-1 S"Nozzle 2" ; Create Tool 2, use extruder drives 1 (extruder) and the highest numbered extruder drive (assist), Heater 2, no filament mapping, and call it "Nozzle 2"
