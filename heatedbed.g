...
M308 S{global.BedSensorNum} P{global.BedTempPin} Y"thermistor" T100000 B3950 C0 A"Bed" ; Create new sensor assigned to pin defined in machinespecific.g. It's thermistor type with resistance of 100Kohms at 25C, reciprocal of Steinhart-Hart B coefficient 3950, Steinhart-Hart C coefficient 0, and call it "Bed"
...
M950 H{global.BedHeaterNum} C{global.BedHeatPin} T{global.BedSensorNum} ; Create new heater using new sensor and bed heat pin as defined in machinespecific.g
