...
; Customized for H4046 (Wprimesurface and Wclearance) - May 4, 2022
...
while iterations < #move.axes ; Loop over all axes
    if {(move.axes[iterations].letter ^ "") == "W"} ; A W-axis is defined, so we have a motor-driven cleaning station.
        G1 W30 F15000 ; Move W to 30mm at 15000 mm/min to extend cleaning station to priming location (Wprimesurface)
        ...
        G1 W20 F6000 ; Move W to 20mm at 6000 mm/min to retract cleaning station to the clearance location for a turret rotation (Wclearance)
