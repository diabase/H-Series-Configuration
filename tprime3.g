; Idle all E motors and switch extruder multiplexer to Tool 3
; MOT 1 (Tool 1) - LLL
; MOT 2 (Tool 5) - LLH
; MOT 3 (Tool 4) - HHL
; MOT 4 (Tool 3) - LHL
...
G90 ; Set to Absolute Positioning
G1 U74.5  F9900; Rotate turret (U) to 74.5  at 9900 mm/min
...
G1 U84    F9900 ; Rotate turret (U) to 84    at 9900 mm/min
G4 P20 ; Dwell for 20 ms
...
G90 ; Set to Absolute Positioning
G1 U174   F9900 ; Rotate turret (U) to 174   (pointing nozzle 3 at the bed) at 9900 mm/min
G4 P20 ; Dwell for 20 ms
