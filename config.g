...
M584 X0 Y1 Z2 U3 V4 W5 A4 C4 B3.0 D3.2 E1.0:1.1:1.2:2.0:2.1:2.2;
M208 X-208 Y-90 Z-10 U0 W0 B-213.5 D0 S1 ; Set axis minima
M208 X208 Y90 U360 W35 B212.5 D40 S0 ; Set axis maxima
M350 X16 Y16 Z16 U16 W16 B16 D16 E16 I1 ; Configure microstepping with interpolation
M92 X320 Y320 Z320 U230.22 W800 B80 D1000 E96 ; Set steps per mm
M566 X300 Y300 Z300 U120 W500 B1000 D1000 E1200 ; Set maximum instantaneous speed changes (mm/min)
M203 X12000 Y12000 Z3000 U8900 W20000 B20000 D1500 E6000 ; Set maximum speeds (mm/min)
M201 X600 Y600 Z450 U600 W500 B600 D600 E250 ; Set accelerations (mm/s^2)
M906 X1800 Y2100 Z1800 U1200 W800 B1600 D2500 E1500:1500:1500:500 I60 ; Set motor currents (mA) and motor idle factor percent
