...
; Drive orientation
M569 P0 S1 ; Set motor driver direction. Motor driver number 0 goes forwards  (S1). Line 33: X (Linear)
M569 P1 S1 ; Set motor driver direction. Motor driver number 1 goes forwards  (S1). Line 33: Y (Linear)
M569 P2 S0 ; Set motor driver direction. Motor driver number 2 goes backwards (S0). Line 33: Z (Linear)
M569 P3 S0 ; Set motor driver direction. Motor driver number 3 goes backwards (S0). Line 33: U (Turret)
M569 P4 S0 ; Set motor driver direction. Motor driver number 4 goes backwards (S0). Line 33: A (Rotary)
M569 P5 S1 ; Set motor driver direction. Motor driver number 5 goes forwards  (S1). Line 33: C (Rotary)
M569 P6 S0 ; Set motor driver direction. Motor driver number 6 goes backwards (S0). Line 33: E:0-3 (Extruders)
M569 P7 S1 ; Set motor driver direction. Motor driver number 7 goes forwards  (S1). Line 33: W (Cleaning Station)
M569 P8 S1 ; Set motor driver direction. Motor driver number 8 goes forwards  (S1). Line 33: V (Turret Lock)
M569 P9 S0 ; Set motor driver direction. Motor driver number 9 goes backwards (S0). Line 33: E4 (Filament Assist)
