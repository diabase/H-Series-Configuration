...
; Drive settings
M584 X{global.xDrive} Y{global.yDrive} Z{global.zDrive} U{global.uDrive} B{global.bDrive} W{global.wDrive} A2.0:2.1 C2.2 E1.0:1.1:1.2:3.0:3.1:3.2; Set driver mapping.
M208 X{global.xMin} Y{global.yMin} Z{global.zMin} U{global.uMin} B{global.bMin} W{global.wMin} A{global.aMin} C{global.cMin} S1 ; Set axis minima
M208 X{global.xMax} Y{global.yMax} Z{global.zMax} U{global.uMax} B{global.bMax} W{global.wMax} A{global.aMax} C{global.cMax} S0 ; Set axis maxima
M350 X16 Y16 Z16 U16 B16 W16 A16 C16 E16 I1 ; Configure microstepping with interpolation - high lead cleaning station motor
M92 X320 Y320 Z320 U230.22 B160 W400 A53.33 C53.33 E96 ; Set steps per mm
M566 X300 Y300 Z300 U120 B200 W200 A1000 C1000 E1200 ; Set maximum instantaneous speed changes (mm/min)
M203 X10000 Y10000 Z3000 U8000 B10000 W13000 A20000 C20000 E6000 ; Set maximum speeds (mm/min)
M201 X600 Y600 Z450 U600 B500 W5000 A600 C600 E250 ; Set accelerations (mm/s^2)
M906 X1800 Y2100 Z2400 U1440 B1500 W1000 A1600 C1600 E1500:1500:1500:1000:1000:1000 I30 ; Set motor currents (mA) and motor idle factor percent
...
M574 B2 S1 P{global.bSwitchPin}
...
M98 p"toolchangersetup.g"   ;Configure toolchanger
