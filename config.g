...
; This config file is a manually-edited blend of the H4031 config file and Austin's
; provided config file on 11/13/2020.
...
M208 X-210 Y-93 Z-10 U-10.3 V-100 W0 A-365 C-1000 S1 ; Set axis minima
...
; Temperature limits
M143 H0 S250 ; Limit Bed temperature to 120C
...
M106 P7 S0 B0 L1 C"Spindle 3" ; Spindle 3 air flow

; Miscellaneous
M911 S19 R22 P"M98 P""estop.g"""  ; Run estop.g on power loss during a print
M575 P1 S1 B115200; Set up UART for pendant input
;M750 ; Enable scanner
