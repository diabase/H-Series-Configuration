...
M208 X-210 Y-93 Z-10 U-9.6 V-100 W0 A-365 C-1000 S1 ; Set axis minima
...
M558 K1 P8 C"duex.e5stop" I0 F200 T12000 ; Set Z probe type for Probe 1 (touchoff plate). It's an unfiltered normally closed switch between the "duex.e4stop" pin and ground, non-inverted probe reading, 200mm/min probing speed, and 12000 mm/min travel speed between probe points
