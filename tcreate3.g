...
M563 P3 D2:{#move.extruders-1} H3 L-1 S"Nozzle 3" ; Create Tool 3, use extruder drives 2 (extruder) and the highest numbered extruder drive (assist), Heater 3, no filament mapping, and call it "Nozzle 3"
