...
; M563 P1 DXXX:{#move.extruders-1} H1 L-1 S"Nozzle 1" ; Create Tool 1, use extruder drives XXX (extruder) and the highest numbered extruder drive (assist), Heater 1, no filament mapping, and call it "Nozzle 1"
