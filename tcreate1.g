...
M308 S1 P"2.temp2" Y"thermistor" T100000 B3950 C0 A"Nozzle 1" ; Create Sensor 1 assigned to duex.e2temp pin, thermistor type with resistance of 100Kohms at 25C, reciprocal of Steinhart-Hart B coefficient 3950, Steinhart-Hart C coefficient 0, and call it "Nozzle 1"
M950 H1 C"2.out2" T1 ; Create Heater 1, assigned to inverse exp.heater3 pin using Sensor 1 for temperature sensing
