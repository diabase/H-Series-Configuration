...
M143 H1 S290 ; Monitor Heater 1 and throw an error if it exceeds 250C
M563 P1 D0:{#move.extruders-1} H1 L-1 S"Nozzle 1" ; Create Tool 1, use extruder drives 0 (extruder) and the highest numbered extruder drive (assist), Heater 1, no filament mapping, and call it "Nozzle 1"
