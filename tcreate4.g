...
M563 P4 D3:{#move.extruders-1} H4 L-1 S"Nozzle 4" ; Create Tool 4, use extruder drives 3 (extruder) and the highest numbered extruder drive (assist), Heater 4, no filament mapping, and call it "Nozzle 4"
...
; M453 T4 S3 C"!exp.heater6" R12000 ; Assign tool 4 to spindle index 3, with PWM control on inverted pin "exp.heater6" and 12000 RPM achieved at full PWM
