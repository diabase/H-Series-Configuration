if tools[{state.currentTool}].spindle>-1
  ...
  M400
  M208 S0 Z{move.axes[2].max-(move.axes[2].max-global.TCZ)+12} ; add extra movement above limit switch, defined as 12mm above toolsetter stud location
  T-1                       ;release tool to remove tool offsets
