...
M143 H5 S250 ; Monitor Heater 5 and throw an error if it exceeds 290C
M563 P5 D4:{#move.extruders-1} H5 L-1 S"Nozzle 5" ; Create Tool 5, use extruder Drives 4 (extruder) and the highest numbered extruder drive (assist), Heater 5, no filament mapping, and call it "Nozzle 5"
