...
M118 S{"Debug: Begin testb-speed.g"} L3
...
while true
    ...
    M291 P{"That was speed ="^{var.speed}^", accel ="^{var.accel}^", and jerk ="^{var.jerk}^". Increase speed to "^{{var.speed+2000}}^"?"} R"B-Axis Parameters" S3
    set var.speed = {var.speed+2000}
    M203 B{var.speed}

M118 S{"Debug: End testb-speed"} L3
