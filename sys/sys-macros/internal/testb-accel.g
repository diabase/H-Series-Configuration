...
M118 S{"Debug: Begin testb-accel.g"} L3
...
while true
    ...
    M291 P{"That was speed ="^{var.speed}^", accel ="^{var.accel}^", and jerk ="^{var.jerk}^". Increase accel to "^{{var.accel+100}}^"?"} R"B-Axis Parameters" S3
    set var.accel = {var.accel+100}
    M201 B{var.accel}

M118 S{"Debug: End testb-accel"} L3
