...
M118 S{"Debug: Begin testz-accel.g"} L3
...
while true
    ...
    M291 P{"That was speed ="^{var.speed}^", accel ="^{var.accel}^", and jerk ="^{var.jerk}^". Increase accel to "^{{var.accel+100}}^"?"} R"Z-Axis Parameters" S3
    set var.accel = {var.accel+100}
    M201 Z{var.accel}

M118 S{"Debug: End testz-accel"} L3
