...
M118 S{"Debug: Begin testz-speed.g"} L3
...
while true
    ...
    M291 P{"That was speed ="^{var.speed}^", accel ="^{var.accel}^", and jerk ="^{var.jerk}^". Increase speed to "^{{var.speed+2000}}^"?"} R"Z-Axis Parameters" S3
    set var.speed = {var.speed+2000}
    M203 Z{var.speed}

M118 S{"Debug: End testz-speed"} L3
