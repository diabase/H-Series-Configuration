; Idle all E motors and switch extruder multiplexer to Tool 2
; MOT 1 (Tool 1) - LLL
; MOT 2 (Tool 5) - LLH
; MOT 3 (Tool 4) - HHL
; MOT 4 (Tool 3) - LHL
...
M116 P2 S5 ; Wait until Tool 2 reaches +/-5C of its set value
...
G1 U12.6  F9900 ; Rotate turret (U) to 12.6  at 9900 mm/min
G4 P20 ; Dwell for 20 ms
...
G90 ; Set to Absolute Positioning
G1 U102   F9900 ; Rotate turret (U) to 102   (pointing nozzle 2 at the bed) at 9900 mm/min
G4 P20 ; Dwell for 20 ms
