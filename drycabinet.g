; drycabinet.g
; Configures parameters for H-Series filament drying cabinet.
...
M141 H6 P1              ; Configure Chamber Heater: Assign Heater 6 to Chamber Heater 1

; Create and Configure Temperature Monitors
